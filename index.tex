...
amounts of data. • KDD: Knowledge Discovery from Data/ Knowledge
Discovery from Data Mining • Process: Automatic or Semi-automatic •
...
counters • Customer purchasing patterns: Identify which items are
frequently sold together? • Products that are likely to be purchased
together.

Why it is useful?

• Can make a purchase suggestion to their customers • Gives an idea that
how we can arrange items in a store to as a strategy for boosting sales.
