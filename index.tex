...
1 0.65266121      0 1.0000000 1.0425061 0.24509628
2 0.19470235      1 0.3473388 0.6949278 0.17914734
3 0.03618342      2 0.1526364 0.4175280 0.13271107
4 0.02324972      3 0.1164530 0.3642353 0.09059916
5 0.02000000      4 0.0932033 0.3524581 0.09534185
...
n= 32 
        ...
        CP nsplit rel error  xerror    xstd
1 0.643125      0   1.00000 1.03831 0.24176
2 0.097484      1   0.35687 0.65057 0.16830
3 0.000100      2   0.25939 0.56072 0.11192
\end{verbatim}
...
rpart(formula = mpg ~ ., data = mtcars, method = "anova", control = rpart.control(cp = 1e-04))
  n= 32 
          ...
          CP nsplit rel error    xerror      xstd
1 0.64312523      0 1.0000000 1.0383066 0.2417574
2 0.09748407      1 0.3568748 0.6505675 0.1683026
3 0.00010000      2 0.2593907 0.5607231 0.1119227
...
\item
  It is an ensemble method combining multiple models
\item
  It splits the data based on feature values to create a tree structure
\item
  It always gives better accuracy than Random Forest
\item
...
\item
  Increase the depth of a single decision tree
\item
  Select the most important feature only
\end{enumerate}
...
\item
  Builds only a single decision tree
\item
  Increases bias intentionally
\end{enumerate}
...
\def\labelenumi{\Alph{enumi})}
\item
  Training multiple weak learners sequentially, focusing on
  misclassified points
\item
  Training multiple models independently and averaging predictions
\item
  Using only deep decision trees as base learners
\item
  Randomly dropping features to reduce correlation
\end{enumerate}
...
\item
  It is a type of boosting method
\item
...
\def\labelenumi{\Alph{enumi})}
\item
  Decrease in the next iteration
\item
  Remain the same
\item
